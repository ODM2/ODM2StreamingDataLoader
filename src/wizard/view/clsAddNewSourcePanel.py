...
class AddNewSourcePanelView ( wx.Panel ):
    def __init__( self, parent ):
        ...
        self.description_txt.SetDescriptiveText(u"Contact Name")
        ...
        self.link_txt = wx.SearchCtrl( sbSizer2.GetStaticBox(), wx.ID_ANY, u"Link", wx.DefaultPosition, wx.DefaultSize, 0 )
