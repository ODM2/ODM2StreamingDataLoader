...
class FileConfigPanelView(wx.Panel):
    def __init__(self, parent, **kwargs):
        ...
        self.Layout()
        '''
        wx.Panel.__init__ ( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 668,327 ), style = wx.TAB_TRAVERSAL )
        ...
        #self.local_file_txt.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOW ) )
        ...
        self.local_file_btn.SetMinSize( wx.Size( 100,-1 ) )
